...
{
    int x = ensPuc.tab[puceronIndex].coordPuceron.x; // mettre *n à la place de n ? pas sur mais je crois pas
    int y = ensPuc.tab[puceronIndex].coordPuceron.y; // not certain
